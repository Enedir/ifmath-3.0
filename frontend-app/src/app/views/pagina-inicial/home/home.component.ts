...
export class HomeComponent implements OnInit {
  ...
  public populaMumerosEOperacoes(): void {
    this.numerosEOperacoes = [
      {
        title: 'Sistema de Numeração',
        routerLink: 'numeros_operacoes/sistemas_numeracao'
      },
      {
        title: 'Números Naturais',
        routerLink: 'numeros_operacoes/numeros_naturais'
      },
      {
        title: 'Múltiplos e Divisores',
        routerLink: 'numeros_operacoes/multiplos_divisores'
      },
      { title: 'Frações', routerLink: 'numeros_operacoes/fracoes' },
      {
        title: 'Número Racionais',
        routerLink: 'numeros_operacoes/numeros_racionais'
      },
      {
        title: 'Números Decimais',
        routerLink: 'numeros_operacoes/numeros_decimais'
      },
      { title: 'Números Reais', routerLink: 'numeros_operacoes/numeros_reais' },
      {
        title: 'Números Inteiros',
        routerLink: 'numeros_operacoes/numeros_inteiros'
      },
    ...
    this.algebraEFuncoes = [
      {
        ...
        routerLink: 'algebra_e_funcoes/equacao_primeiro_grau'
      },
      {
      ...
      { title: 'Trigonometria', routerLink: 'algebra_e_funcoes/trigonometria' },
      {
        ...
        routerLink: 'algebra_e_funcoes/analise_combinatoria'
      },
      {
        title: 'Razão e proporção',
        routerLink: 'algebra_e_funcoes/razao_e_proporcao'
      },
      ...
      { title: 'Porcentagem', routerLink: 'algebra_e_funcoes/porcentagem' },
      {
        ...
        routerLink: 'algebra_e_funcoes/juros_simples_e_compostos'
      },
      {
        title: 'Progressão Aritmética',
        routerLink: 'algebra_e_funcoes/progressao_aritmetica'
      },
      {
        title: 'Progressão Geométrica',
        routerLink: 'algebra_e_funcoes/progressao_geometrica'
      }
    ];
  }
